...
export default function Page() {
  return (
    <>
      <PageHeader
        title="Datenschutz"
        description="Wie deine Daten auf dieser Seite verarbeitet werden."
      />
      <Section grow className="select-none">
        <Article>
          <h2>Sprache dieser Seite</h2>
          <p>
            Diese Datenschutzerklärung ist auf Deutsch verfasst, da sie den
            rechtlichen Anforderungen des Wohnsitzlandes entspricht und keine
            kommerzielle Absicht besteht. Die übrigen Inhalte dieser Seite sind
            auf Englisch gehalten, um dem internationalen Standard gerecht zu
            werden.
          </p>
          ...
          <p>
            ...
            von Vercel. Die Verwendung von Vercel erfolgt auf Grundlage von Art.
            6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer
          ...
          <p>
            ...
            Taner Kampa
            <br />
            Albert-Einstein-Straße 31, 84048 Mainburg
            <br />
            <br />
