...
import { type HTMLAttributes, memo, useEffect, useId, useRef } from "react";
...
interface DotFieldBackgroundProps extends HTMLAttributes<HTMLDivElement> {
  dotRadius?: number;
  dotSpacing?: number;
  cursorRadius?: number;
  cursorForce?: number;
...
DotField.displayName = "DotFieldBackground";
